...
export const RegisterSection = () => {
  return (
    <section id="register" className="bg-bgPink border-t-4 border-fontOrange">
      <div className="container flex flex-col items-center mx-auto space-y-0 md:flex-row md:space-y-0 px-5 pt-10 md:pt-0">
        ...
        <div className="flex flex-col items-center md:w-1/2">
          <h1 className="text-2xl font-bold text-center text-fontOrange animate-bounce md:text-4xl ">
